...
\RequirePackage[utf8]{inputenc}		% it is assumed that all source files are UTF8 encoded!
...
with mathematical structures \cite{mathmode10}. While smaller equations like
%
\begin{equation}
\bar{\mathbf{M}} =  
\begin{pmatrix}
