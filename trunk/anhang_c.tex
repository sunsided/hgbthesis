...
Hintergrundtönung der Code-Listings heller (auf 2.5\% Grau) eingestellt.
...
\item[2015/09/19]
Alle \texttt{.cls} und \texttt{.sty} Dateien sind jetzt ANSI-codiert, wie
laut CTAN-Richtlinien vorgesehen. Umlautzeichen wurden durch Makros ersetzt.
\verb!\RequirePackage[utf8]{inputenc}! steht jetzt nur mehr am Beginn
