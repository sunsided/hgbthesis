...
Als Gesamtpaket bietet sich \emph{TeXstudio}\footnote{\url[http://texstudio.sourceforge.net/]} an. In diesem Fall kann die Installation eines separaten PDF-Viewers entfallen, dieser ist in der Software bereits enthalten.
