...
\include{frontmatter/vorwort}		% ggfs. weglassen
...
\include{chapters/diplomschrift}
...
%%%Anhang
\appendix
\include{appendix/anhang_a}	% Technische Ergänzungen
\include{appendix/anhang_b}	% Inhalt der CD-ROM/DVD
\include{appendix/anhang_c}	% Chronologische Liste der Änderungen
\include{appendix/anhang_d}	% Quelltext dieses Dokuments
