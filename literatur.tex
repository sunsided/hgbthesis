...
hat, die aber in einer anderen, vorliegenden Quelle \textbf{B} zitiert wird.
In diesem Fall bezeichnet man \textbf{A} als \emph{Original-} oder \emph{Primärquelle} und \textbf{B} 
als \emph{Sekundärquelle}. Dabei sollte man folgende Grundregeln beachten:
%
\begin{itemize}
\item
...
angegeben werden, wie in nachfolgedem Beispiel gezeigt.
\item
...
Möglichkeiten:
\begin{enumerate}
\item Das Quellenverzeichnis manuell zu formatieren (s.\ \cite[Abschn.\ 11.3]{Kopka2003}).
\item Die Verwendung von \texttt{BibTeX}/\texttt{Biber} und einer zugehörigen 
Literaturdatenbank
(s.\ \cite[Kap.\ 12]{Kopka2003}).
\end{enumerate}
...
erzeugt. Literatur zur Verwendung von BibTeX findet man online, \zB \cite{Feder2006,Patashnik88}.
...
Besonders sollte man dabei auf die korrekte Angabe der Namen, also 
